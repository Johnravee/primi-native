        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <ScrollView contentContainerStyle={styles.scrollViewContainer}>
                <View style={styles.imgView}>
                    <Image style={styles.imageBanner} source={require('../assets/hardwarelogo.jpg')} />
                </View>
                ...
                <LeftSideImg  
                    ...
                    ImageUrl={require('../assets/ram.png')}
                    borderRadiu={0}  />
                ...
                <RightSideImg  
                    ...
                    ImageUrl={require('../assets/mobo.png')} 
                    borderRadiu={0} />
                ...
                <LeftSideImg  
                    ...
                    ImageUrl={require('../assets/hdd.png')}
                    borderRadiu={0}  />
                ...
                <RightSideImg  
                    ...
                    ImageUrl={require('../assets/gpu.png')}
                    borderRadiu={0}  />
